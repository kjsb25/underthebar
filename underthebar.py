...
class Login(QtWidgets.QDialog):
	...
	def __init__(self, parent=None):
		...
		self.buttonAutoLogin = QtWidgets.QPushButton('Auto Browser Cookie Login', self)
		...
		layout.addWidget(QtWidgets.QLabel('''<p align=center><b>Log in via browser (recommended)</b></p><p align=center>Log in to Hevy in your browser, close it, then click below.</p><p> </p>'''))
